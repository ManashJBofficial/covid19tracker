...
function rajasthan() {
  fetch("https://api.covid19india.org/data.json")
    ...
    .then(function (data) {
      let rajasthanUpdate = data.statewise[14].lastupdatedtime;
      document.getElementById("rajasthanUpdate").innerHTML = rajasthanUpdate;

      let rajasthanState = data.statewise[14].state;
      document.getElementById("rajasthanState").innerHTML = rajasthanState;

      let rajasthanActive = data.statewise[14].active;
      document.getElementById("rajasthanActive").innerHTML = rajasthanActive;

      let rajasthanConfirmed = data.statewise[14].confirmed;
      document.getElementById(
        "rajasthanConfirmed"
      ).innerHTML = rajasthanConfirmed;

      let rajasthanRecovered = data.statewise[14].recovered;
      document.getElementById(
        "rajasthanRecovered"
      ).innerHTML = rajasthanRecovered;

      let rajasthanDeceased = data.statewise[14].deaths;
      document.getElementById(
        "rajasthanDeceased"
...
function puducherry() {
  fetch("https://api.covid19india.org/data.json")
    ...
    .then(function (data) {
      let puducherryUpdate = data.statewise[23].lastupdatedtime;
      document.getElementById("puducherryUpdate").innerHTML = puducherryUpdate;

      let puducherryState = data.statewise[23].state;
      document.getElementById("puducherryState").innerHTML = puducherryState;

      let puducherryActive = data.statewise[23].active;
      document.getElementById("puducherryActive").innerHTML = puducherryActive;

      let puducherryConfirmed = data.statewise[23].confirmed;
      document.getElementById(
        "puducherryConfirmed"
      ).innerHTML = puducherryConfirmed;

      let puducherryRecovered = data.statewise[23].recovered;
      document.getElementById(
        "puducherryRecovered"
      ).innerHTML = puducherryRecovered;

      let puducherryDeceased = data.statewise[23].deaths;
      document.getElementById(
        "puducherryDeceased"
...
function nagaland() {
  fetch("https://api.covid19india.org/data.json")
    ...
    .then(function (data) {
      let nagalandUpdate = data.statewise[29].lastupdatedtime;
      document.getElementById("nagalandUpdate").innerHTML = nagalandUpdate;

      let nagalandState = data.statewise[29].state;
      document.getElementById("nagalandState").innerHTML = nagalandState;

      let nagalandActive = data.statewise[29].active;
      document.getElementById("nagalandActive").innerHTML = nagalandActive;

      let nagalandConfirmed = data.statewise[29].confirmed;
      document.getElementById(
        "nagalandConfirmed"
      ).innerHTML = nagalandConfirmed;

      let nagalandRecovered = data.statewise[29].recovered;
      document.getElementById(
        "nagalandRecovered"
      ).innerHTML = nagalandRecovered;

      let nagalandDeceased = data.statewise[29].deaths;
...
function chandigarh() {
  fetch("https://api.covid19india.org/data.json")
    ...
    .then(function (data) {
      let chandigarhUpdate = data.statewise[26].lastupdatedtime;
      document.getElementById("chandigarhUpdate").innerHTML = chandigarhUpdate;

      let chandigarhState = data.statewise[26].state;
      document.getElementById("chandigarhState").innerHTML = chandigarhState;

      let chandigarhActive = data.statewise[26].active;
      document.getElementById("chandigarhActive").innerHTML = chandigarhActive;

      let chandigarhConfirmed = data.statewise[26].confirmed;
      document.getElementById(
        "chandigarhConfirmed"
      ).innerHTML = chandigarhConfirmed;

      let chandigarhRecovered = data.statewise[26].recovered;
      document.getElementById(
        "chandigarhRecovered"
      ).innerHTML = chandigarhRecovered;

      let chandigarhDeceased = data.statewise[26].deaths;
      document.getElementById(
        "chandigarhDeceased"
...
function meghalaya() {
  fetch("https://api.covid19india.org/data.json")
    ...
    .then(function (data) {
      let meghalayaUpdate = data.statewise[30].lastupdatedtime;
      document.getElementById("meghalayaUpdate").innerHTML = meghalayaUpdate;

      let meghalayaState = data.statewise[30].state;
      document.getElementById("meghalayaState").innerHTML = meghalayaState;

      let meghalayaActive = data.statewise[30].active;
      document.getElementById("meghalayaActive").innerHTML = meghalayaActive;

      let meghalayaConfirmed = data.statewise[30].confirmed;
      document.getElementById(
        "meghalayaConfirmed"
      ).innerHTML = meghalayaConfirmed;

      let meghalayaRecovered = data.statewise[30].recovered;
      document.getElementById(
        "meghalayaRecovered"
      ).innerHTML = meghalayaRecovered;

      let meghalayaDeceased = data.statewise[30].deaths;
      document.getElementById(
        "meghalayaDeceased"
