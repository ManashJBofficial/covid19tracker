...
function up() {
    fetch('https://api.covid19india.org/data.json')
        ...
        .then(function (data) {
            ...
            let upAct = data.statewise[6].active;
            document.getElementById('upAct').innerHTML = upAct;

            let upCon = data.statewise[6].confirmed;
            document.getElementById('upCon').innerHTML = upCon;

            let upRec = data.statewise[6].recovered;
            document.getElementById('upRec').innerHTML = upRec;

            let upDec = data.statewise[6].deaths;
...
function ct() {
    fetch('https://api.covid19india.org/data.json')
        ...
        .then(function (data) {
            ...
            let ctAct = data.statewise[20].active;
            document.getElementById('ctAct').innerHTML = ctAct;

            let ctCon = data.statewise[20].confirmed;
            document.getElementById('ctCon').innerHTML = ctCon;

            let ctRec = data.statewise[20].recovered;
            document.getElementById('ctRec').innerHTML = ctRec;

            let ctDec = data.statewise[20].deaths;
...
function tripura() {
    fetch('https://api.covid19india.org/data.json')
        ...
        .then(function (data) {
            ...
            let triAct = data.statewise[23].active;
            document.getElementById('triAct').innerHTML = triAct;

            let triCon = data.statewise[23].confirmed;
            document.getElementById('triCon').innerHTML = triCon;

            let triRec = data.statewise[23].recovered;
            document.getElementById('triRec').innerHTML = triRec;

            let triDec = data.statewise[23].deaths;
...
function puducherry() {
    fetch('https://api.covid19india.org/data.json')
        ...
        .then(function (data) {
            ...
            let pudAct = data.statewise[24].active;
            document.getElementById('pudAct').innerHTML = pudAct;

            let pudCon = data.statewise[24].confirmed;
            document.getElementById('pudCon').innerHTML = pudCon;

            let pudRec = data.statewise[24].recovered;
            document.getElementById('pudRec').innerHTML = pudRec;

            let pudDec = data.statewise[24].deaths;
...
function manipur() {
    fetch('https://api.covid19india.org/data.json')
        ...
        .then(function (data) {
            ...
            let manAct = data.statewise[25].active;
            document.getElementById('manAct').innerHTML = manAct;

            let manCon = data.statewise[25].confirmed;
            document.getElementById('manCon').innerHTML = manCon;

            let manRec = data.statewise[25].recovered;
            document.getElementById('manRec').innerHTML = manRec;

            let manDec = data.statewise[25].deaths;
...
function hp() {
    fetch('https://api.covid19india.org/data.json')
        ...
        .then(function (data) {
            ...
            let hpAct = data.statewise[26].active;
            document.getElementById('hpAct').innerHTML = hpAct;

            let hpCon = data.statewise[26].confirmed;
            document.getElementById('hpCon').innerHTML = hpCon;

            let hpRec = data.statewise[26].recovered;
            document.getElementById('hpRec').innerHTML = hpRec;

            let hpDec = data.statewise[26].deaths;
