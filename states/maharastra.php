...
<meta charset="UTF-8">
    ...
    <meta name="keywords"
        content="CORONA TRACKER, CORONA-VIRUS TRACKER, COVID-19 TRACKER, INDIA COVID-19 CORONA TRACKER, INDIA, WORLD, STATEWISE, DISTRICTWISE,covid, covid19, covid-19, covid19india, coronavirus, corona, india, virus, pandemic, disease, carona, karona, korona, Maharastra ">
    <meta name="author" content="Manash Jyoti Baruah">
    <title>COVID-19 Tracker | Maharastra</title>
    ...
    <div class="container ">
        <div class="row">
            <div class="col col-lg-12 py-5">
                <h1 class="banner-text  py-5 text-center">Maharastra</h1>
                ...
                <div class="table-responsive ">
                    <table class="table table-striped  table-dark table-bordered text-center table-hover shadow-md">
                        <thead>
                            <tr>
