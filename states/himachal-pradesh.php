...
<meta charset="UTF-8">
    ...
    <meta name="keywords"
        content="CORONA TRACKER, CORONA-VIRUS TRACKER, COVID-19 TRACKER, INDIA COVID-19 CORONA TRACKER, INDIA, WORLD, STATEWISE, DISTRICTWISE,covid, covid19, covid-19, covid19india, coronavirus, corona, india, virus, pandemic, disease, carona, karona, korona, Himachal Pradesh ">
...
<div class="row justify-content-center align-items-center">
        ...
        <!--Search Box End-->
            <h1 class="banner-text  py-5 text-center">Himachal Pradesh</h1>
